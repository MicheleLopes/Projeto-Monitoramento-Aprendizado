...
st.set_page_config(page_title='Progresso Turmas Cientista', page_icon=favicon)
...
def main():
    ...
    if st.session_state['authentication_status']:
        ...
        # Carregar e tratar os dado
        df = bigquery_client.carregar_dados('cientista')
        ...
        cursos = st.sidebar.multiselect("Selecione os cursos que gostaria de visualizar:",
                                        ['boas_vindas', 'portifolio', 'linkedin', 'FTC', 'SQL', 'GIT', 
                                        'ambiente_virtual', 'fundamentos_ML', 'DS_producao', 'storytelling',
                                        'estatistica', 'PA_classificao', 'metricas_negocio', 'PA_clusterizacao',
                                        'BD_relacional', 'RH', 'elasticidade_preco','GCP', 'AWS'],
                                        default=['boas_vindas', 'portifolio', 'linkedin', 'FTC', 'SQL', 'GIT', 
                                        'ambiente_virtual', 'fundamentos_ML', 'DS_producao', 'storytelling',
                                        'estatistica', 'PA_classificao', 'metricas_negocio', 'PA_clusterizacao',
                                        'BD_relacional', 'RH', 'elasticidade_preco','GCP', 'AWS'])
        st.sidebar.markdown('---')
